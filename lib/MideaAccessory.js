...
class MideaAccessory {
    constructor(platform, accessory, _deviceId, _deviceType, _name, _userId) {
        ...
        this.acVerticalSwing = 0;
        this.acHorizontalSwing = 0;
        this.ecoMode = false;
        ...
        this.waterLevel = 0;
        this.waterLevelWarningLevel = 0;
        this.dhVerticalSwing = 0;
        // Common
        this.powerState = 0;
    ...
    currentHeaterCoolerState() {
        if (this.powerState === this.platform.Characteristic.Active.INACTIVE) {
            ...
            switch (this.operationalMode) {
                case MideaOperationalMode_1.MideaOperationalMode.Cooling:
                ...
                case MideaOperationalMode_1.MideaOperationalMode.Heating:
                    if (this.indoorTemperature <= this.targetTemperature) {
                ...
                case MideaOperationalMode_1.MideaOperationalMode.Auto:
                    if (this.indoorTemperature >= this.targetTemperature) {
                        return this.platform.Characteristic.CurrentHeaterCoolerState.COOLING;
                    }
