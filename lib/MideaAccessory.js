...
class MideaAccessory {
    ...
    handleTargetHeaterCoolerStateSet(value, callback) {
        ...
        switch (value) {
            ...
            default:
                {
                    this.platform.Characteristic.CurrentHeaterCoolerState.Active.ACTIVE;
                }
                callback(null, value);
        }
    }
    ...
    handleCoolingThresholdTemperatureGet(callback) {
        this.platform.log.debug('Triggered GET handleCoolingThresholdTemperature:', this.targetTemperature);
    ...
    handleHeatingThresholdTemperatureGet(callback) {
        this.platform.log.debug('Triggered GET handleHeatingThresholdTemperature:', this.targetTemperature);
        // set this to a valid value for TargetTemperature
        callback(null, this.targetTemperature);
    }
    ...
    handleFanActiveGet(callback) {
        this.platform.log.debug('Triggered GET Fan:', this.fanOnlyMode);
    ...
    handleFanActiveSet(value, callback) {
        ...
        // workaround to get the "fan only mode" from device
        // device operation values are 1.0="Auto",2.0="Cool",3.0="Dry",4.0="Heat",5.0="Fan"
        if (value == MideaOperationalMode_1.MideaOperationalMode.FanOnly) {
