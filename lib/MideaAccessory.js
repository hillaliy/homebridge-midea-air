...
const ACOperationalMode_1 = require("./enums/ACOperationalMode");
const DehumidifierOperationalMode_1 = require("./enums/DehumidifierOperationalMode");
class MideaAccessory {
    constructor(platform, accessory, _deviceId, _deviceType, _name, _userId) {
        ...
        this.operationalMode = ACOperationalMode_1.ACOperationalMode.Off;
        this.fanSpeed = 0;
        this.name = '';
        this.model = '';
        this.userId = '';
    ...
    currentHeaterCoolerState() {
        if (this.powerState === this.platform.Characteristic.Active.INACTIVE) {
            ...
            switch (this.operationalMode) {
                case ACOperationalMode_1.ACOperationalMode.Dry:
                case ACOperationalMode_1.ACOperationalMode.Cooling:
                ...
                case ACOperationalMode_1.ACOperationalMode.Heating:
                    if (this.indoorTemperature <= this.targetTemperature) {
                ...
                case ACOperationalMode_1.ACOperationalMode.Auto:
                    if (this.indoorTemperature > this.targetTemperature) {
                        return this.platform.Characteristic.CurrentHeaterCoolerState.COOLING;
                    }
    ...
    targetHeaterCoolerState() {
        if (this.operationalMode === ACOperationalMode_1.ACOperationalMode.Cooling) {
            return this.platform.Characteristic.TargetHeaterCoolerState.COOL;
        }
        else if (this.operationalMode === ACOperationalMode_1.ACOperationalMode.Heating) {
    ...
    handleTargetHeaterCoolerStateSet(value, callback) {
        if (this.targetHeaterCoolerState() !== value) {
            ...
            if (value === this.platform.Characteristic.TargetHeaterCoolerState.AUTO) {
                this.operationalMode = ACOperationalMode_1.ACOperationalMode.Auto;
            }
            else if (value === this.platform.Characteristic.TargetHeaterCoolerState.COOL) {
                this.operationalMode = ACOperationalMode_1.ACOperationalMode.Cooling;
            }
            else if (value === this.platform.Characteristic.TargetHeaterCoolerState.HEAT) {
                this.operationalMode = ACOperationalMode_1.ACOperationalMode.Heating;
            }
            this.platform.sendUpdateToDevice(this);
        }
        ;
    ...
    fanActive() {
        if (this.operationalMode === ACOperationalMode_1.ACOperationalMode.FanOnly && this.powerState === this.platform.Characteristic.Active.ACTIVE) {
    ...
    handleFanActiveSet(value, callback) {
        ...
        if (value === 1 && this.powerState === 1) {
            this.operationalMode = ACOperationalMode_1.ACOperationalMode.FanOnly;
        }
    ...
    currentHumidifierDehumidifierState() {
        if (this.powerState === 0) {
            ...
            switch (this.operationalMode) {
                case DehumidifierOperationalMode_1.DehumidifierOperationalMode.Normal:
                    return this.platform.Characteristic.CurrentHumidifierDehumidifierState.HUMIDIFYING;
                case DehumidifierOperationalMode_1.DehumidifierOperationalMode.Continuous:
                case DehumidifierOperationalMode_1.DehumidifierOperationalMode.Smart:
                    return this.platform.Characteristic.CurrentHumidifierDehumidifierState.IDLE;
                case DehumidifierOperationalMode_1.DehumidifierOperationalMode.Dryer:
    ...
    TargetHumidifierDehumidifierState() {
        switch (this.operationalMode) {
            case DehumidifierOperationalMode_1.DehumidifierOperationalMode.Off:
                return this.platform.Characteristic.Active.INACTIVE;
            case DehumidifierOperationalMode_1.DehumidifierOperationalMode.Normal:
    ...
    handleTargetHumidifierDehumidifierStateSet(value, callback) {
        ...
        if (this.TargetHumidifierDehumidifierState() !== value) {
            if (value === this.platform.Characteristic.TargetHumidifierDehumidifierState.HUMIDIFIER_OR_DEHUMIDIFIER) {
                this.operationalMode = DehumidifierOperationalMode_1.DehumidifierOperationalMode.Smart;
            }
            else if (value === this.platform.Characteristic.TargetHumidifierDehumidifierState.HUMIDIFIER) {
                this.operationalMode = DehumidifierOperationalMode_1.DehumidifierOperationalMode.Normal;
            }
            else if (value === this.platform.Characteristic.TargetHumidifierDehumidifierState.DEHUMIDIFIER) {
                this.operationalMode = DehumidifierOperationalMode_1.DehumidifierOperationalMode.Dryer;
            }
            ;
            this.platform.sendUpdateToDevice(this);
        }
    ...
    handleRelativeHumidityThresholdGet(callback) {
    ...
    handleRelativeHumidityThresholdSet(value, callback) {
