...
class Utils {
    ...
    static getSign(path, form) {
        if (path != '' && form) {
            ...
            return crypto_1.default
                .createHash("sha256")
                .update(postfix + query + Constants_1.default.SupportedApps.NetHomePlus.AppKey)
                .digest("hex");
        }
        else {
            return false;
    ...
    static getSignPassword(loginId, password) {
        if (loginId != '' && password != '') {
            ...
            return crypto_1.default
                .createHash("sha256")
                .update(loginId + pw + Constants_1.default.SupportedApps.NetHomePlus.AppKey)
                .digest("hex");
        }
        else {
            return '';
    ...
    static generateDataKey(accessToken) {
        if (accessToken != '') {
            const md5AppKey = crypto_1.default
                .createHash("md5")
                .update(Constants_1.default.SupportedApps.NetHomePlus.AppKey).digest("hex");
